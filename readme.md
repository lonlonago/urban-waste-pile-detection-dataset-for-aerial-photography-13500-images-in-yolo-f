# Urban waste pile detection dataset for aerial photography 13500 images in Yolo format.

# Body

The aerial photography dataset for detecting urban waste piles contains 13,500 images in the Yolo format. The images are clear and well-annotated, making them suitable for training models such as YOLOv4, which can be directly used for scenarios such as waste pile detection, environmental monitoring, and urban governance.
